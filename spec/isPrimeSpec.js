describe('Prime number generator', function () {
    ...
    it('returns 2 when number is 3', function () {
        expect(isPrime(3)).toEqual([2]);
    });
    it('returns 2, 3, 5 when number is 7', function () {
        expect(isPrime(7)).toEqual([2,3,5]);
    });
    it('returns 2,3,5,7,11 when number is 15', function () {
        expect(isPrime(15)).toEqual([2,3,5,7,11]);
    });
    it('returns an empty array when number is 1', function () {
        expect(isPrime(1)).toEqual([]);
    });
    it('returns an empty string when number is 2', function () {
